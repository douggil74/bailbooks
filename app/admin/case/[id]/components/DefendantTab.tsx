    ...
    <div className="space-y-6">
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <CaseField label="Phone" value={caseInfo.defendant_phone} field="defendant_phone" onChange={updateCaseInfo} onBlur={blurSaveCaseInfo} disabled={saving} type="tel" placeholder="(985) 555-1234" />
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <CaseField label="Employer Phone" value={caseInfo.employer_phone} field="employer_phone" onChange={updateCaseInfo} onBlur={blurSaveCaseInfo} disabled={saving} type="tel" placeholder="(985) 555-5678" />
        </div>
      </div>
